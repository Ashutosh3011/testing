...
class _SignInScreenState extends State<SignInScreen> {
  ...
  mobileValidator() {
    // final StateSetManager mobile =
    //     Provider.of<StateSetManager>(context, listen: false);
    if (mobileController.text.length != 10) {
      Scaffold.of(context).showSnackBar(
          SnackBar(content: Text('Please Enter a Valid Mobile Number')));
    } else {
      String mobileText = mobileController.text;
      print(mobileText);
      _sharedPreferences.setString('mobile', mobileText);
      // mobile.mobileValue(mobileText);
